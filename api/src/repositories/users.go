...
func (repository usersRepository) Follow(userId uint64, followedId uint64) error {
...
func (repository usersRepository) UnFollow(userId uint64, followedId uint64) error {
